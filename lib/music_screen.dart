...
class _MusicScreenState extends State<MusicScreen>
  ...
  // ── Design tokens ─────────────────────────────────────────────────────
  static const Color _ink = Color(0xFF0D0D0F);
  static const Color _inkSoft = Color(0xFF1A1A1F);
  static const Color _inkCard = Color(0xFF222228);
  static const Color _textHigh = Color(0xFFF5F5F7);
  static const Color _textMid = Color(0xFF9A9AA8);
  static const Color _textLow = Color(0xFF55555F);
  ...
  void _openPlayer(int index) {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, a, __) => MusicPlayerScreen(
          song: enriched[index],
          playlist: enriched,
          currentIndex: index,
        ),
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Divider(color: _textLow.withValues(alpha: 0.4)),
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            pal[0].withValues(alpha: 0.85),
            pal[1].withValues(alpha: 0.5),
            _ink,
          ],
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: isSel ? null : _inkCard,
                borderRadius: BorderRadius.circular(22),
                boxShadow: isSel
                    ? [
                        BoxShadow(
                          color: pal[0].withValues(alpha: 0.45),
                          blurRadius: 12,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: isSel ? Colors.white : _textMid,
                      fontSize: 13,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: pal[0].withValues(alpha: 0.4),
              blurRadius: 24,
  ...
  Widget _buildNavPill(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _textLow.withValues(alpha: 0.35), width: 0.8),
        boxShadow: [
          BoxShadow(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: isActive
                      ? LinearGradient(
                          colors: [
                            pal[0].withValues(alpha: 0.28),
                            pal[1].withValues(alpha: 0.18),
                          ],
                        )
                      : null,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive ? null : _inkCard,
          gradient: isActive
              ? LinearGradient(
                  colors: [
                    palette[0].withValues(alpha: 0.18),
          ...
          border: isActive
              ? Border.all(color: palette[0].withValues(alpha: 0.35), width: 1)
              : null,
        ),
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Container(width: 26, height: 12, color: const Color(0xFF333340)),
            const SizedBox(width: 10),
            Container(
              width: 52,
              height: 52,
            ...
            Expanded(
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Container(height: 13, color: const Color(0xFF333340)),

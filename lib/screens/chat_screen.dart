...
class _ChatScreenState extends State<ChatScreen> {
  ...
  static const Map<String, Map<String, String>> _botStrings = {
    'English': {
      ...
      'Anxious':
          "Take a deep breath. You've got this, {name}!\nHere are some calming picks:",
      'Bored':
          "Let's fix that boredom!\nHere are some exciting picks, {name}:",
      'Motivated':
    ...
    'Hindi': {
      ...
      'Happy': "खुशी आप पर खूब जँचती है, {name}!\nगुड वाइब्स के लिए:",
      'Sad': "{name}, ये आपको बेहतर महसूस कराएगा:",
      'Anxious': "गहरी सांस लें। आप कर सकते हैं, {name}!\nशांत करने वाले पिक्स:",
      'Bored': "बोरियत दूर करते हैं!\n{name} के लिए मजेदार पिक्स:",
      'Motivated': "चलो {name}!\nएनर्जी बढ़ाने के लिए:",
      'Romantic': "{name} के रोमांटिक मूड के लिए:",
    ...
    'Tamil': {
      ...
      'Happy': "மகிழ்ச்சி, {name}!\nநல்ல வைப்ஸ் தொடர:",
      'Sad': "{name}, இவை உதவும்:",
      'Anxious': "ஆழமாக சுவாசியுங்கள், {name}!\nசில அமைதியான பிக்ஸ்:",
      'Bored': "சலிப்பை சரி செய்வோம்!\n{name} க்கு பிக்ஸ்:",
      'Motivated': "வாங்க {name}!\nஆற்றலை அதிகரிக்க:",
      'Romantic': "{name} க்கு ரோமாண்டிக் பிக்ஸ்:",
    ...
    'Telugu': {
      ...
      'Sad': "{name}:",
      'Anxious': "లోతుగా శ్వాసించండి, {name}!\nప్రశాంతమైన పిక్స్:",
      'Bored': "విసుగు తొలగిద్దాం! {name}:",
    ...
    'Kannada': {
      ...
      'Sad': "{name}:",
      'Anxious': "ಉಸಿರಾಡಿ {name}!\nಶಾಂತ ಪಿಕ್ಸ್:",
      'Bored': "ಬೇಸರ ನಿವಾರಿಸೋಣ! {name}:",
    ...
    'Malayalam': {
      ...
      'Happy': "{name}!\nനല്ല വൈബ്സ് തുടരാൻ:",
      'Sad': "{name}:",
      'Anxious': "ശ്വസിക്കൂ {name}!\nശാന്തമായ പിക്സ്:",
      'Bored': "മടുപ്പ് മാറ്റാം! {name}:",
    ...
    'Bengali': {
      ...
      'Sad': "{name}:",
      'Anxious': "গভীরে শ্বাস নিন {name}!\nশান্তিপূর্ণ পিক্স:",
      'Bored': "বিরক্তি দূর করা যাক! {name}:",
      'Motivated': "চলো {name}!",
      'Romantic': "{name}:",
    ...
    'Spanish': {
      ...
      'Sad': "{name}:",
      'Anxious': "Respira profundo {name}!\nAlgunas opciones relajantes:",
      'Bored': "¡Arreglemos el aburrimiento! {name}:",
    ...
    'French': {
      ...
      'Sad': "{name}:",
      'Anxious': "Respire profondément {name}!\nQuelques choix apaisants:",
      'Bored': "Réglons cet ennui! {name}:",
    ...
    'German': {
      ...
      'Sad': "{name}:",
      'Anxious': "Atme tief durch {name}!\nEinige beruhigende Picks:",
      'Bored': "Lass uns die Langeweile vertreiben! {name}:",
      'Motivated': "Los geht's {name}!",
      'Romantic': "{name}:",
      'welcome_title': "Hallo {name}! Ich bin Lix",
      'welcome_sub': "Sag mir deine Stimmung, frag nach Songs\nin jeder Sprache!",
    },
    'Japanese': {
      'greeting': "こんにちは {name}さん! 私はLixです!\n\nどの言語でも曲をリクエストできます!",
      'smalltalk': "私はLixです!\n\n• ムード映画\n• どの言語でも曲\n\n何でも聞いて!",
      'thanks': "どういたしまして!",
      ...
      'Happy': "{name}さん!\nその良い気分を続けるために:",
      'Sad': "{name}さん:",
      'Anxious': "深呼吸して {name}さん!\n落ち着くピックス:",
      'Bored': "退屈を解消しましょう! {name}さん:",
    ...
    'Korean': {
      ...
      'Happy': "{name}님!\n좋은 분위기 유지하기 위해:",
      'Sad': "{name}님:",
      'Anxious': "깊게 숨을 쉬세요 {name}님!\n진정시키는 픽스:",
      'Bored': "지루함을 해결해봐요! {name}님:",
      'Motivated': "가자 {name}님!",
      'Romantic': "{name}님:",
  ...
  Widget _buildMovieRow(List<Map<String, String>> movies) {
    const cardH = 220.0;
    const imageH = 140.0;
    final cardW = Responsive.isDesktop(context) ? 180.0 : MediaQuery.of(context).size.width * 0.32;
    return SizedBox(
      height: cardH,
      child: ListView(
  ...
  Widget _buildMessage(Map<String, dynamic> message) {
    ...
    final maxW = Responsive.isDesktop(context) ? 650.0 : MediaQuery.of(context).size.width * 0.75;
    if (isUser) {
      return Align(
      ...
      return Align(
        ...
        child: Container(
          ...
          constraints: BoxConstraints(
            maxWidth: Responsive.isDesktop(context) ? 750.0 : MediaQuery.of(context).size.width * 0.92,
          ),
          decoration: BoxDecoration(
